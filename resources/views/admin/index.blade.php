                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                      ...
                      <!--   <li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-calendar-alt"></i>Pages</a>
                        ...
                        <div class="row m-t-25">
                             <div class="col-md-6 col-lg-4">
                                <div class="statistic__item">
                                    ...
                                    <a href="/user-admin">
                                        <span class="desc">TOTAL PELANGGAN</span>
                                    </a>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="statistic__item">
                                    <h2 class="number">{{$makanan->count()}}</h2>
                                    <a href="/makanan-admin">
                                        <span class="desc">TOTAL MAKANAN</span>
                                    </a>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="statistic__item">
                                    <h2 class="number">10,368</h2>
                                    <span class="desc">TOTAL TRANSAKSI</span>
                                    <div class="icon">
