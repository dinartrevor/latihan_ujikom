            ...
            <div class="col-md-12">
              ...
              <div class="table-data__tool">
                ...
                <div class="table-data__tool-right">
                  <a href="tambah-order.html" class="au-btn au-btn-icon au-btn--green au-btn--small">
                  <i class="zmdi zmdi-plus"></i>Tambah Order</a>
                </div>
              </div>
                    ...
                    <table id="example" class="table table-striped table-bordered text-center" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Pedas lvl 5</td>
                          <td>
                            <a href="edit-order.html" class="btn btn-primary">Edit</a> | 
